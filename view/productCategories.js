...
productCategories.get('/allresults', (req, res) => {
...
productCategories.post('/add', (req, res) => {
...
productCategories.post('/update', (req, res) => {
...
productCategories.delete('/delete', (req, res) => {
