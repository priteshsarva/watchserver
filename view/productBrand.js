...
const productBrand = express()

productBrand.get('/allresults', (req, res) => {

    
    res.set('content-type', 'application/json');
    let sql = `SELECT * FROM ProductBrand ;`
    try {
        DB.all(sql, [], (err, rows) => {
            if (err) {
                throw err;
...
productBrand.post('/update', (req, res) => {
...
productBrand.delete('/delete', (req, res) => {
